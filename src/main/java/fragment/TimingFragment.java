    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.timing_10min:
                ...
                Toast.makeText(getActivity(), "将在10分钟后停止播放", Toast.LENGTH_SHORT).show();
                dismiss();
                break;
            case R.id.timing_20min:

                Toast.makeText(getActivity(), "将在20分钟后停止播放", Toast.LENGTH_SHORT).show();
                dismiss();
                break;
            case R.id.timing_30min:

                Toast.makeText(getActivity(), "将在30分钟后停止播放", Toast.LENGTH_SHORT).show();
                dismiss();
                break;
            case R.id.timing_45min:

                Toast.makeText(getActivity(), "将在45分钟后停止播放", Toast.LENGTH_SHORT).show();
                dismiss();
                break;
            case R.id.timing_60min:

                Toast.makeText(getActivity(), "将在60分钟后停止播放", Toast.LENGTH_SHORT).show();
                dismiss();
                break;
            case R.id.timing_90min:

                Toast.makeText(getActivity(), "将在90分钟后停止播放", Toast.LENGTH_SHORT).show();
                dismiss();
                break;
        }
    }
